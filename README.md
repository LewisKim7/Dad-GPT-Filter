...
이 Raw URL을 AdGuard 또는 ABP 호환 사용자 정의 필터 목록에 등록해 사용할 수 있습니다.
...
1. `dad-gpt-filter.txt`의 Raw URL을 복사합니다.
2. 사용하는 콘텐츠 차단기의 사용자 정의 필터 / 필터 구독 메뉴에 Raw URL을 추가합니다.
3. 필터를 활성화합니다.
4. Samsung Internet에서 `chatgpt.com`을 새로고침합니다.

도구별 메뉴 이름은 다를 수 있습니다.
